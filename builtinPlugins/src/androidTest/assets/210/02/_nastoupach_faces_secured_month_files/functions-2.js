    ...
    if (state !== "disabled") {
        jQuery.ajax({
            ...
            success: function (data) {
                $('#orderContent' + day).load('db/dbJidelnicekOnDay.jsp?day=' + day + '&terminal=' + getParameterByName('terminal') + '&printer=' + getParameterByName('printer') + '&keyboard=' + getParameterByName('keyboard') + ' #orderContent' + day + '>*', '');
